...
from API_A.Common.public.read_ini import configuration
...
class Mylog:
    ...
    def __init__(self):
        ...
        self.logger_level=configuration('D:\pycharm\API_A\Common\conf\case_option.ini').read_str('LOG','logger_level')
        self.file_level=configuration('D:\pycharm\API_A\Common\conf\case_option.ini').read_str('LOG','file_level')
        self.file_name=configuration('D:\pycharm\API_A\Common\conf\case_option.ini').read_str('LOG','file_name')
        self.formatter=configuration('D:\pycharm\API_A\Common\conf\case_option.ini').read_str('LOG','formatter')
