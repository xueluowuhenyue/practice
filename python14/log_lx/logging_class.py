...
class Mylog:
    ...
    def __init__(self):
        ...
        self.logger_level=configuration('D:\pycharm\python14\log_lx\log.ini').read_str('LOG','logger_level')
        self.file_level=configuration('D:\pycharm\python14\log_lx\log.ini').read_str('LOG','file_level')
        self.file_name=configuration('D:\pycharm\python14\log_lx\log.ini').read_str('LOG','file_name')
        self.formatter=configuration('D:\pycharm\python14\log_lx\log.ini').read_str('LOG','formatter')
