...
error_whole_ten=[{'Caseid':5,'module':'投标','title':'投资金额不是整十数','bid_name':'第一个项目','amount':'99','expect':'请输入10的整数倍'}]

success_data=[{'Caseid':6,'module':'投标','title':'正常投资','bid_name':'第一个项目','amount':'100','expect':'投标成功！'}]
